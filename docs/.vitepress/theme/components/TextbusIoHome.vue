...
<template>
  <div class="tb-io-home">
    <div class="static-editor" :class="{ 'bg-loaded': bgLoaded }">
      <div class="banner ui-container-fluid">
        <div class="ui-container content">
          <h1 class="name">5.0 正式发布</h1>
          <div class="slogan">支持主从结构、高性能的富文本库</div>
          <p class="desc">原生支持 Viewfly、React、Vue 渲染富文本</p>
          <p>
            <a class="btn btn-quick-start" href="/guide/getting-started" role="button">
              快速上手

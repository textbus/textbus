...
各 **`@textbus/*`** 包在下列分节中有 **导出与类型索引**；接入步骤、示例与概念以主题指南为准，并与本表交叉引用。
...
| [@textbus/adapter-react](./package-adapter-react) | React 视图适配 |
| [@textbus/platform-node](./package-platform-node) | Node 工具集 |

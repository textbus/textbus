...
import { createRef, Injectable, onMounted } from '@viewfly/core'
import { createVNode, Registry, Selection } from '@textbus/core'
import { CommentService, Editor, Organization } from '@textbus/xnote'
...
function App() {
  ...
  function applyJSON() {
    editor.setContent(JSON.parse(textareaRef.value!.value).state)
  }
    ...
    return (
      <div class="app">
        ...
        <div style={{
          ...
          <div className="btn-list">
            <div>
              <button type="button" onClick={applyJSON}>替换为框内 JSON</button>
